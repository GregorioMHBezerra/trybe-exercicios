...
input.addEventListener('input', (evento) => {
  const textoClasseTech = document.getElementsByClassName('tech')[0];
  textoClasseTech.innerText = evento.target.value;
});
...
myWebpage.addEventListener('dblclick', (evento) => {
  location.replace('https://gregoriomhbezerra.github.io/')
})
